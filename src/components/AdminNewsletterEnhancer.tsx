  ...
  shortcut.innerHTML = `
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <h2 class="mt-2 text-xl font-semibold text-gray-900">Weekly Newsletter Builder</h2>
    ...
    <div class="mt-5 grid gap-3 md:grid-cols-2">
      <div class="rounded-2xl border border-gray-200 bg-slate-50 px-4 py-3">
        ...
        <p class="mt-1 text-sm text-gray-600">Preview the reusable Take Back Weekly letter design.</p>
      </div>
      <div class="rounded-2xl border border-gray-200 bg-slate-50 px-4 py-3">
        <div class="text-sm font-semibold text-gray-900">Weekly Newsletter</div>
        <p class="mt-1 text-sm text-gray-600">Write this week's letter, preview it, select subscribers, and schedule the email.</p>
      </div>
    </div>
  `;
