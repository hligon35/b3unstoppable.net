  ...
  return (
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden gradient-hero pt-28 md:pt-32">
      ...
      <div className="section-padding relative z-10 text-center">
        ...
        >
          <Link href={content.primaryCtaHref} className="btn-primary">{content.primaryCtaLabel}</Link>
          <Link href={content.secondaryCtaHref} className="btn-outline">{content.secondaryCtaLabel}</Link>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {content.bookingText} <Link href={content.bookingLinkHref} className="underline text-brandOrange">{content.bookingLinkLabel}</Link> today!
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-brandOrange">{content.eventBadgeLabel}</p>
