      ...
      <div className="section-padding grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-12">
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="h-30 w-30 relative">
              <Image src={B3ULogo} alt="B3U Logo" fill className="object-contain" />
            </div>
          </div>
          <div className="mb-4">
          ...
          <Link href="/booking" className="btn-primary mt-5 inline-flex">Book Dr. Bree</Link>
        </div>
        ...
        <div>
          ...
          <form className="space-y-3" onSubmit={onFootSubmit} ref={footFormRef}>
            ...
            <TurnstileField token={turnstileToken} onTokenChange={setTurnstileToken} resetKey={turnstileResetKey} theme="dark" />
            ...
            {footSubbed && <div className="text-green-200 bg-green-900/30 border border-green-700/50 rounded-md px-3 py-2 text-xs">Thanks! You’re subscribed.</div>}
            {footError && <div className="text-red-200 bg-red-900/30 border border-red-700/50 rounded-md px-3 py-2 text-xs">{footError}</div>}
          </form>
        </div>
      </div>
