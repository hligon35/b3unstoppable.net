  ...
  const aboutStructuredData = useMemo(
    () =>
      createWebPageStructuredData({
        ...
        description:
          'Meet Dr. Bree Charles, founder of B3U: Burn, Break, Become Unstoppable. She helps leaders move beyond survival mode and reclaim identity, voice, and purpose.',
        keywords: [
          'About Dr. Bree Charles',
    ...
    >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
            <div className="order-1 md:order-2">
              <p className="text-lg text-navy/80 leading-relaxed mb-6">
                Dr. Bree Charles is a transformational speaker, U.S. Army veteran, author, and
                founder of B3U: Burn, Break, Become Unstoppable. She equips strong, dependable
                leaders to move beyond survival mode, reclaim their identity, voice, and purpose,
                and lead with clarity.
              </p>
              <p className="text-lg text-navy/80 leading-relaxed mb-6">
                Her message is shaped by 16 years of active-duty military service, three deployments
                to Iraq, and a personal journey through trauma, domestic violence, PTSD, and life
                beyond the uniform. These experiences taught her both how to lead under pressure and
                the hidden cost of staying strong for everyone while losing yourself.
              </p>
              <p className="text-lg text-navy/80 leading-relaxed mb-6">
                She is the author of <em>The Big Take Back: What I Left Behind</em>, a memoir and
                teaching journey that helps readers confront repeating patterns, reclaim what life
                tried to take, and rebuild with intention.
              </p>
              <p className="text-lg text-navy/80 leading-relaxed mb-6">
                Dr. Bree&apos;s keynotes and workshops blend authentic storytelling, leadership
                insight, and actionable tools for corporations, government agencies,
                military-connected organizations, professional associations, and leadership groups.
                Her work addresses identity, resilience, transition, burnout, and purpose-driven
                leadership.
              </p>
              <p className="text-lg text-navy/80 leading-relaxed">
                Grounded in faith, Dr. Bree believes transformation begins when people stop allowing
                their past, others&apos; expectations, or the roles they carry to define who they
                are becoming. She does more than inspire audiences. She equips them to move from
      ...
      <section className="section-padding bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div className="rounded-2xl bg-brandOrange p-7 text-white shadow-lg">
              <h3 className="text-2xl font-bold mb-3">Burn</h3>
              <p>the beliefs and labels that keep you trapped.</p>
            </div>
            <div className="rounded-2xl bg-brandOrange p-7 text-white shadow-lg">
              <h3 className="text-2xl font-bold mb-3">Break</h3>
              <p>the cycles that fuel burnout, silence, and disconnection.</p>
            </div>
            <div className="rounded-2xl bg-brandOrange p-7 text-white shadow-lg">
              <h3 className="text-2xl font-bold mb-3">Become</h3>
              <p>the clear, confident, purpose-driven leader you were created to be.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="section-padding bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-navy/80 leading-relaxed">
            Dr. Bree&apos;s memoir and teaching journey helps readers confront repeating patterns,
            reclaim what life tried to take, and rebuild with intention.
          </p>
      ...
      <section className="section-padding bg-brandBlue-light/20">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-center text-navy/80 mb-10 max-w-3xl mx-auto">
            Dr. Bree&apos;s work supports national, virtual, corporate, government, military,
            association, university, and leadership audiences seeking practical tools for identity,
            resilience, transition, burnout, and purpose-driven leadership.
          </p>
          {/* <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-10">
            {['Identity', 'Resilience', 'Transition', 'Burnout', 'Purpose-Driven Leadership'].map(
              (topic) => (
      ...
      <section className="section-padding bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-center text-navy/80 mb-12 max-w-3xl mx-auto">
            Dr. Bree&apos;s leadership and service also extend into community-based initiatives
            designed to create practical impact.
          </p>
      ...
      <section className="section-padding bg-navy text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg leading-relaxed mb-8 max-w-3xl mx-auto">
            Book Dr. Bree for your next keynote, workshop, leadership program, or organizational
            event.
          </p>
          <Link href="/booking" className="btn-primary">
            Book Dr. Bree
