  ...
  const structuredData = useMemo(
    () =>
      createWebPageStructuredData({
        ...
        description:
          'Book Dr. Bree Charles for national, virtual, corporate, government, military, association, university, and leadership events focused on identity, resilience, transition, burnout, voice, and purpose.',
        keywords: [
          'Dr. Bree Charles speaker',
      ...
      <section className="section-padding bg-gradient-to-br from-navy via-[#0f3150] to-[#194d75] text-white">
        <div className="mx-auto max-w-5xl text-center pt-12">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg text-white/85">
            Dr. Bree equips leaders to move beyond survival mode, reclaim their identity, voice, and
            purpose, and lead with clarity.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mt-4 text-3xl md:text-4xl font-bold text-navy">
            The Leader Behind the Role: Reclaiming Identity, Voice, and Purpose Before Burnout Takes
            Over
          </h2>
          <p className="mt-6 text-lg leading-relaxed text-navy/80">
            Strong, dependable leaders often become so consumed by performing, serving, and carrying
            responsibility that they lose themselves behind the role. In this transformational
            keynote, Dr. Bree Charles helps audiences recognize the hidden cost of survival-mode
            leadership and take practical steps toward greater clarity, resilience, and purpose.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <ul className="mt-8 grid gap-4 md:grid-cols-2">
            {outcomes.map((outcome) => (
              <li key={outcome} className="card bg-white text-navy/80">
                {outcome}
              </li>
            ))}
          </ul>
      ...
      {/* <section className="section-padding bg-gray-50">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            <div className="card bg-white min-h-[280px] flex flex-col items-center justify-center text-center">
              <p className="text-sm uppercase tracking-[0.2em] text-brandOrange font-semibold">
                Speaker Video
              </p>
              <h3 className="mt-3 text-xl font-bold">Professional Video Coming Soon</h3>
              <p className="mt-3 text-sm text-navy/60">
                Speaker reel or keynote footage will appear here when the final media is available.
              </p>
            </div>
            <div className="card bg-white min-h-[280px] flex flex-col items-center justify-center text-center">
              <p className="text-sm uppercase tracking-[0.2em] text-brandOrange font-semibold">
              ...
              <h3 className="mt-3 text-xl font-bold">Professional Photo Coming Soon</h3>
              <p className="mt-3 text-sm text-navy/60">
                Professional stage and audience-engagement photography will be featured here.
              </p>
            </div>
            <div className="card bg-white min-h-[280px] flex flex-col items-center justify-center text-center">
              <p className="text-sm uppercase tracking-[0.2em] text-brandOrange font-semibold">
              ...
              <h3 className="mt-3 text-xl font-bold">Download Coming Soon</h3>
              <p className="mt-3 text-sm text-navy/60">
                A downloadable professional speaker one-sheet will be available here.
              </p>
            </div>
          </div>
        </div>
          ...
          {/* <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="card bg-brandBlue-light/10">
              ...
              <p className="mt-4 text-navy/65">
                Professional speaking-result testimonials coming soon.
              </p>
            </div>
            <div className="card bg-brandBlue-light/10">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brandOrange">
      ...
      <section className="section-padding bg-navy text-white text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-white/80">
            Book Dr. Bree for a keynote, workshop, leadership program, or organizational event.
          </p>
          <Link href="/booking" className="btn-primary mt-8 inline-flex">
            Request Dr. Bree for Your Event
          </Link>
        </div>
      </section>
    </Layout>
